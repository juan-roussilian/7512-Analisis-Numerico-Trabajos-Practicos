...
def newton_raphson_mod_rec(f, f_prima, f_prima_prima, semilla, tolerancia, iteraciones):
    x = symbols('x')
    ...
    return newton_raphson_mod_rec(f, f_prima, f_prima_prima, siguiente, tolerancia, iteraciones - 1)
...
def newton_raphson_mod(f, intervalo, tolerancia, iteraciones=-1):
    ...
    return newton_raphson_mod_rec(f, f_prima, f_prima_prima, semilla, tolerancia, iteraciones)
